# Blackbox readiness adapter for ros2/teleop_twist_keyboard

This fork contains a small Blackbox Robotics compatibility capsule for teleoperation command ownership input.
